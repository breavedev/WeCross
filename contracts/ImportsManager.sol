...
/// @title Cross network Imports helper to manage all required import which is used in all tokenomics contracts
    ...
    ReentrancyGuardUpgradeable
{
    ...
    /// @notice Function to let Cross to update the address of the Safety Module
